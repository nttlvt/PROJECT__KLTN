...
export const Login = () => {
    ...
    // }
    // handleLogin()
    // const url = 'http://localhost:8080/updateProduct/45'; 
    ...
    // Make a PUT or PATCH request using Axios
    // axios.put(url, updateData) // You can also use axios.patch for partial updates
    //     .then(response => {
    //         // Handle success
            ...
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                <div className="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                    <div className="flex flex-col justify-center p-8 md:p-14">
                        ...
                        {/* <GoogleLogin className="w-full flex justify-center gap-6 items-center border border-gray-300 text-md p-2 rounded-lg mb-6"
